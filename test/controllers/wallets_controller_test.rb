...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { amount: @wallet.amount, receiver_user_id: @wallet.receiver_user_id, remark: @wallet.remark, sender_user_id: @wallet.sender_user_id } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { amount: @wallet.amount, receiver_user_id: @wallet.receiver_user_id, remark: @wallet.remark, sender_user_id: @wallet.sender_user_id } }
